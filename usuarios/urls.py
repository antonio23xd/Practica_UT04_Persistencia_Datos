...
from usuarios.views import alta_usuario, crear_tarea_individual, visualizar_datos_usuario, visualizar_lista_usuarios, visualizar_tareas_alumno, visualizar_tareas_profesor
